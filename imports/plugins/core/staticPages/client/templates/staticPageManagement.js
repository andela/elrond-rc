...
import "./staticPageManagement.html";
import "/node_modules/simplemde/dist/simplemde.min.css";
import { Reaction } from "/client/api";

let simplemde;
Template.staticPageManagement.onRendered(() => {
  ...
  $(".editor-toolbar").append(
    $("<a/>")
      ...
      .attr("tabindex", "-1")
      .addClass("static-pages-new")
  );
});
Template.staticPageManagement.onDestroyed(() => {
  $("#main").css("overflow", "auto");
});

Template.staticPageManagement.helpers({
  baseUrl() {
...
Template.staticPageManagement.events({
